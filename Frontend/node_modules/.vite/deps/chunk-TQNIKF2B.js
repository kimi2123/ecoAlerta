...
var PickerAdapterContext = React33.createContext(null);
...
var LocalizationProvider = function LocalizationProvider2(inProps) {
  ...
  } = React33.useContext(PickerAdapterContext) ?? {
    utils: void 0,
    adapter: void 0,
    localeText: void 0
  };
  ...
  const localeText = React33.useMemo(() => _extends({}, themeLocaleText, parentLocaleText, inLocaleText), [themeLocaleText, parentLocaleText, inLocaleText]);
  const adapter = React33.useMemo(() => {
    if (!DateAdapter) {
      if (parentAdapter) {
...
`));
  ...
  const defaultDates = React33.useMemo(() => {
    if (!adapter) {
      return null;
    }
    return {
...
@mui/system/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-TQNIKF2B.js.map
